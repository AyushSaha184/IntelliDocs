...
class BM25Retriever:
    ...
    def _tokenize(self, text: str) -> List[str]:
        ...
        and splits by whitespace for clean keyword matching.
        This same tokenizer is used at both index-time and query-time
        ...
        tokens = text.split()
        return [t for t in tokens if len(t) > 1]  # drop single-char noise
